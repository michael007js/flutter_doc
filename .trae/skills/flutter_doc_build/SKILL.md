...
- 脚本目录为【工程目录】（定义见 [flutter_doc_constraints 名词约束](file:///c:/app/flutter%20doc/.trae/skills/flutter_doc_constraints/SKILL.md#名词约束)），脚本文件名为`build.bat`
...
可以在 VS Code 的调试面板中选择这些配置来运行和调试项目。默认使用项目根目录的 .venv 虚拟环境。
...
- [flutter_doc_testing](file:///c:/app/flutter%20doc/.trae/skills/flutter_doc_testing/SKILL.md) - 测试计划
